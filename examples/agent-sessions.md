...
## Persisting session in database
...
)  # Note, we are using new session name it will respond with "I do not have access to your personal information, so I do not know your name."
