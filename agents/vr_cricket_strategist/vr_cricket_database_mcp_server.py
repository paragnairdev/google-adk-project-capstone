...
print("Initializing ADK get_player_stats tool...")
adk_tool_to_expose = FunctionTool(get_player_stats)
...
mcp_server = Server("vr_cricket_database_mcp_server")
...
async def call_mcp_tool(
    name: str,
    arguments: dict
) -> list[mcp_types.Content]: # MCP uses mcp_types.Content for responses
    ...
    async with mcp.server.stdio.stdio_server() as (read_stream, write_stream):
        ...
        await mcp_server.run(
            ...
            InitializationOptions(
                server_name=mcp_server.name, # Use the server name defined above
